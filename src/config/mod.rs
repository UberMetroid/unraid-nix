...
pub use presets::{get_preset_path, get_service_command_preset};
...
mod tests {
    ...
    fn test_service_command_presets() {
        let cmd = get_service_command_preset(
            "radarr",
        ...
        let cmd_jellyfin = get_service_command_preset(
            "jellyfin",
            ...
            None,
            Vec::new(),
            Some("8097:8096,8921:8920".to_string()),
        ...
        let err = get_service_command_preset(
            "invalid",
            "/tmp",
            "/tmp",
            99,
