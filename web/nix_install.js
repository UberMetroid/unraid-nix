...
function updatePresetInfo() {
    ...
    var icons = {
        ...
        "prowlarr": "fa-search",
        "pterodactyl": "fa-server",
        "pufferpanel": "fa-server",
        "pyload": "fa-server",
        "pymedusa": "fa-server",
        "qbittorrent": "fa-download",
        "qbittorrent-vpn": "fa-download",
        "radarr": "fa-film",
        "rclone": "fa-cloud-upload",
        "readarr": "fa-book",
        "recyclarr": "fa-server",
        "redis": "fa-database",
        "requestrr": "fa-server",
